    ...
    if educations.empty?
      ...
      educations.each do |e|
        new_educations = Education.create(
          ...
          start_date: (Date.parse("1/#{e.end_date.month ? p.end_date.month : 1}/#{e.end_date.year}") rescue nil), 
          end_date: (Date.parse("1/#{e.end_date.month ? p.end_date.month : 1}/#{e.end_date.year}") rescue nil), 
          degree: e.degree, 
